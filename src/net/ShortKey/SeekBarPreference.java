...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private static int DEFAULT_VALUE = 14;

    private int DefaultMaxValue = 14;
    private int DefaultMinValue = 2;

    private int mMaxValue = 14;
    private int mMinValue = 2;
    private int mInterval = 1;
    private int mCurrentValue = 14;
    ...
    private void setDefaultValues(Context context) {
        ...
        DEFAULT_VALUE = mMaxValue = DefaultMaxValue = am.getStreamMaxVolume(AudioManager.STREAM_MUSIC) - 1;
        mMinValue = DefaultMinValue = 2;
    }
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        mMaxValue = attrs.getAttributeIntValue(ANDROIDNS, "max", DefaultMaxValue);
